<section id="page-heart" class="tab-content">
    ...
    <style>
        /* ================= STYLE KHUSUS HALAMAN HEART RATE ================= */
        
        /* 1. Widget Kalender (Bagian Atas) - Tema Terang/Biru Pastel */
        .calendar-widget {
        ...
        .cal-day-num { 
            ...
            border-radius: 50%; font-size: 1rem; font-weight: 600; color: var(--text-dark); transition: 0.3s;
        }
        
        /* Tanggal yang sedang dipilih (Aksen Biru Primary) */
        ...
        .btn-action { 
            background: var(--primary-light); color: var(--primary); width: 100%; border: 2px solid var(--primary); padding: 12px; 
            border-radius: 16px; font-weight: 700; font-size: 1rem; cursor: pointer;
            transition: all 0.2s; 
        }
        .btn-action:hover { background: var(--primary); color: white; box-shadow: 0 4px 12px rgba(104, 169, 207, 0.3); }
        .btn-action:active { transform: scale(0.98); }

        /* 2. Timeline Riwayat (Bagian Bawah) */
        ...
        /* Garis Lurus di belakang */
        .timeline-container::before {
            content: ''; position: absolute; left: 62px; top: 10px; bottom: 0; width: 2px; background: var(--border-light); z-index: 0;
        }
        ...
        /* Bulatan penanda di atas garis */
        .timeline-node { 
            width: 14px; height: 14px; border-radius: 50%; background: white; 
            border: 3px solid var(--primary); margin-top: 17px; flex-shrink: 0;
            box-shadow: 0 0 0 4px var(--bg-main); /* Efek memotong garis */
        }
    ...
    <div class="calendar-widget">
        ...
        <div class="cal-days" id="calendar-days">
            <div class="cal-day">
                <span class="cal-day-name">Sen</span><span class="cal-day-num">22</span>
            </div>
            <div class="cal-day active">
                <span class="cal-day-name">Sel</span><span class="cal-day-num">23</span>
            </div>
            <div class="cal-day">
                <span class="cal-day-name">Rab</span><span class="cal-day-num">24</span>
            </div>
            <div class="cal-day">
                <span class="cal-day-name">Kam</span><span class="cal-day-num">25</span>
            </div>
            <div class="cal-day">
                <span class="cal-day-name">Jum</span><span class="cal-day-num">26</span>
            </div>
        </div>
